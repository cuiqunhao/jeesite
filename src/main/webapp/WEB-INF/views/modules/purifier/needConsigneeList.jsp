...
<ul class="nav nav-tabs">
	<li class="active">
		<a href="${ctx}/goodsApp/needConsigneeList/">货物申请列表</a>
	</li>
...
<!--查询区-->
<form:form id="searchForm" modelAttribute="goodsApp" action="${ctx}/goodsApp/needConsigneeList" method="post" class="breadcrumb form-search">
