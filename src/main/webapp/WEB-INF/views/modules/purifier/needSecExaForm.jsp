...
<ul class="nav nav-tabs">
	<li><a href="${ctx}/goodsApp/needSecExaList/">货物申请列表</a></li>
	<li class="active">
		<a href="${ctx}/goodsApp/needSecExaForm?id=${goodsApp.id}">申请单${not empty goodsApp.id?'修改':'添加'}
		</a>
	</li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="goodsApp" action="${ctx}/goodsApp/save?opt=ecsh" method="post" class="form-horizontal">
	<form:hidden path="id"/>
